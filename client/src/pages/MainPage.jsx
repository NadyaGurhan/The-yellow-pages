...
export default function MainPage({ user }) {
  ...
  // const filteredCompanies = filterCompanies(companies, searchName);
  //подтягиваю компании
  useEffect(() => {
  ...
  //  const totalPages = Math.ceil(filteredCompanies.length / companiesInPage);
  // const startIndex = (page - 1) * companiesInPage;
  ...
  //когда меняется серчнейм то обновляю страницу
  // useEffect(() => {
  //   setPage(1);
  // }, [searchName]);
